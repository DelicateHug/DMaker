/**
 * Subprocess and Process Execution Utilities
 *
 * Consolidated module for:
 * - Subprocess management for CLI providers (spawn, JSONL streaming)
 * - WSL (Windows Subsystem for Linux) utilities for cross-platform CLI support
 */
