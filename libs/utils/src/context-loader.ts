 ...
 *
 * Provides a shared utility to load context files from .dmaker/context/
 * and memory files from .dmaker/memory/, formatting them as system prompt
...
/**
 * Memory file info (from .dmaker/memory/)
 */
 ...
 * Compatible with secureFs from @dmaker/platform
...
export interface LoadContextFilesOptions {
  ...
  /** Whether to include memory files from .dmaker/memory/ (default: true) */
...
/**
 * Load context files from a project's .dmaker/context/ directory
 * and optionally memory files from .dmaker/memory/
 *
