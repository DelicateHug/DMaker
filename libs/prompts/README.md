...
AI prompt templates for text enhancement and other AI-powered features in DMaker.
...
```typescript
import { getSystemPrompt } from '@dmaker/prompts';
...
```typescript
import { getExamples } from '@dmaker/prompts';
...
```typescript
import { buildUserPrompt } from '@dmaker/prompts';
...
```typescript
import { isValidEnhancementMode } from '@dmaker/prompts';
...
```typescript
import { getAvailableEnhancementModes } from '@dmaker/prompts';
...
```typescript
import { isValidEnhancementMode, getAvailableEnhancementModes } from '@dmaker/prompts';
...
```typescript
import { getSystemPrompt, buildUserPrompt, getExamples } from '@dmaker/prompts';
...
- `@dmaker/types` - Type definitions for EnhancementMode and EnhancementExample

## Used By

- `@dmaker/server` - Enhancement API routes
