 ...
 * Tool Types
 *
 * Consolidated types for external tool integrations:
 * - Cursor CLI configuration, permissions, and stream events
 * - Editor "Open In" functionality
 */
 ...
 * Stored in: .dmaker/cursor-config.json
 */
