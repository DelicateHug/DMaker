...
- Double check and debug if there's memory leaks. It seems like the memory of dmaker grows like 3 gigabytes. It's 5gb right now and I'm running three different cursor cli features implementing at the same time.
