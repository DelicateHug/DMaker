...
/**
 * Heavy Markdown renderer implementation.
 * This component is lazy-loaded by the `Markdown` wrapper in `markdown.tsx`
 * to keep `react-markdown` and its rehype plugins out of the main bundle.
 *
