/**
 * Context File Editor Dialog - Create/Edit context files with view/edit mode
 */
...
interface ContextFileEditorDialogProps {
  open: boolean;
...
export function ContextFileEditorDialog({
  open,
  onOpenChange,
  file,
  initialContent,
  onSave,
}: ContextFileEditorDialogProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle>{isEditing ? `Context: ${file.name}` : 'New Context File'}</DialogTitle>
            {isEditing && (
              <Button
                variant="ghost"
                size="sm"
        ...
        <div className="flex-1 overflow-y-auto space-y-4 py-2">
          {mode === 'view' ? (
            ...
            <div className="space-y-4">
              {/* File Name */}
              <div>
                <Label htmlFor="context-filename">File Name</Label>
                <input
                  id="context-filename"
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="coding-standards.md"
                  disabled={isEditing}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="What this context file is for..."
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Enter context rules, coding standards, or instructions for AI agents..."
                  rows={14}
