/**
 * Memory File Card - Display card for a single memory file with actions
 */
...
import { ChevronDown, ChevronRight, Brain, Pencil, MoreVertical, Trash2, Type } from 'lucide-react';
        ...
        <div className="flex items-start gap-3 p-4">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <Switch
              ...
              className="scale-75"
              title={file.enabled ? 'Disable memory file' : 'Enable memory file'}
            />
            <Button
              variant="ghost"
              size="sm"
