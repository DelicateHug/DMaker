...
The DMaker Agent Chat now supports multiple concurrent sessions, allowing you to organize different conversations by topic, feature, or task. Each session is independently managed and persisted.
...
```
~/Library/Application Support/dmaker/agent-sessions/
```

**Windows:**

```
%APPDATA%/dmaker/agent-sessions/
```

**Linux:**

```
~/.config/dmaker/agent-sessions/
```
...
ls -la ~/Library/Application\ Support/dmaker/

# Fix permissions if needed
chmod -R u+w ~/Library/Application\ Support/dmaker/
```
