...
try {
  ...
  const uiNewVersion = bumpVersion(uiPackageJsonPath, '@dmaker/ui');
  ...
  const serverNewVersion = bumpVersion(serverPackageJsonPath, '@dmaker/server');
  ...
  console.log(`📦 Updated @dmaker/ui: ${uiOldVersion} -> ${uiNewVersion}`);
  console.log(`📦 Updated @dmaker/server: ${serverOldVersion} -> ${serverNewVersion}`);
