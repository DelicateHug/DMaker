/**
 * Security utilities - Authentication, rate limiting, and Codex auth checking
 *
 * Consolidated from auth-utils.ts and codex-auth.ts
 */

import { spawn } from 'child_process';
import { spawnProcess, findCodexCliPath } from '@dmaker/platform';
import { createLogger } from '@dmaker/utils';

const logger = createLogger('Security');

// ============================================================================
// Auth Utilities (from auth-utils.ts)
// ============================================================================
