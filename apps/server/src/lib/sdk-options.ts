...
import { isPathAllowed, PathNotAllowedError, getAllowedRootDirectory } from '@dmaker/platform';
 ...
 * - DMAKER_MODEL_SPEC: Model for spec generation
 * - DMAKER_MODEL_FEATURES: Model for feature generation
 * - DMAKER_MODEL_SUGGESTIONS: Model for suggestions
 * - DMAKER_MODEL_CHAT: Model for chat
 * - DMAKER_MODEL_DEFAULT: Fallback model for all operations
 */
export function getModelForUseCase(
  ...
  const envVarMap: Record<string, string | undefined> = {
    spec: process.env.DMAKER_MODEL_SPEC,
    features: process.env.DMAKER_MODEL_FEATURES,
    suggestions: process.env.DMAKER_MODEL_SUGGESTIONS,
    chat: process.env.DMAKER_MODEL_CHAT,
    auto: process.env.DMAKER_MODEL_AUTO,
    default: process.env.DMAKER_MODEL_DEFAULT,
  };
