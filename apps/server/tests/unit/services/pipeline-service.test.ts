...
describe('pipeline-service.ts', () => {
  ...
  describe('getPipelineConfig', () => {
    ...
    it('should read and return existing config', async () => {
      ...
      const configPath = path.join(testProjectDir, '.dmaker', 'pipeline.json');
  ...
  describe('savePipelineConfig', () => {
    it('should save config to file', async () => {
      ...
      vi.mocked(ensureDmakerDir).mockResolvedValue(undefined);
      ...
      expect(ensureDmakerDir).toHaveBeenCalledWith(testProjectDir);
