# Adding New Cursor Models to DMaker

This guide explains how to add new Cursor CLI models to DMaker. The process involves updating a single file with automatic propagation to the UI.
...
- [ ] Rebuilt types package (`npm run build -w @dmaker/types`)
